...
var _base = __webpack_require__(337);

var _base2 = _interopRequireDefault(_base);

var _timer = __webpack_require__(338);

var _timer2 = _interopRequireDefault(_timer);

var _calculate = __webpack_require__(339);
    ...
    _createClass(Timer, [{
        ...
        value: function countdown(end, update, handle) {
            ...
            if (now - end > 0) {
                ...
                handle.call(self); // 执行倒计时结束的回调 handle
            } else {
                // 倒计时没有结束
                // 剩余时间
                ...
                update.call(self, r.join('')); // 执行每次更新时间时的回调函数 update，使用的是计算之后的倒计时时间
...
var Calculate = function () {
    ...
    _createClass(Calculate, [{
        ...
        value: function computeCount(active, play_name) {
            var count = 0;
            var exist = this.play_list.has(play_name); //判断玩法列表里面是否有这样的玩法,map类型
